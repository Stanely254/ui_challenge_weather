...
mixin _$WeatherData {
  ...
  @JsonKey(name: WeatherFields.description)
  String? get description => throw _privateConstructorUsedError;
  @JsonKey(name: WeatherFields.icon)
...
class _$WeatherDataImpl implements _WeatherData {
  _$WeatherDataImpl(
      ...
      @JsonKey(name: WeatherFields.description) this.description,
      @JsonKey(name: WeatherFields.icon) this.icon});
...
abstract class _WeatherData implements WeatherData {
  factory _WeatherData(
          ...
          @JsonKey(name: WeatherFields.main) final String? main,
          @JsonKey(name: WeatherFields.description) final String? description,
          @JsonKey(name: WeatherFields.icon) final String? icon}) =
      _$WeatherDataImpl;
